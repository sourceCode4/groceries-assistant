...
//                    "CREATE TYPE diettype AS ENUM ('VEGAN', 'VEGETARIAN', 'PESCETARIAN','OMNIVORE');" +
    ...
    //Initial the Food table for each user.
    public static void createUserFoodTable() {
    ...
    //Add rows(with all the food key) for the new user with the input username.
    public static void addUserFoodTable(String x) {
